...
class Plugin extends EventEmitter{
    ...
    getWidget(name){
        ...
        //if(name==="assets")return getAssetsManager
        //if(name==="virtual")return getVirtualModuleManager
        //if(name==="variable")return getVariableManager
        //if(name==="graph")return getBuildGraphManager
        //if(name==="token")return getTokenManager
        //if(name==="cache")return getCacheManager
        //if(name==="table")return getTableManager
    }
