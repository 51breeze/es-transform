...
function createCJSImports(ctx, importManage){
    ...
    importManage.getAllImportSource().forEach(importSource=>{
        ...
        //   const source = importSource.getSourceTarget();
        //     if(Utils.isCompilation(source) || Utils.isModule(source)){
        //         console.log(ctx.target.file, '==============', importSource.sourceId, importSource.specifiers.length )
        //      }
