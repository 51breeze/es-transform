...
import {createCommentsNode, createMainAnnotationNode,createStaticReferenceNode, createUniqueHashId} from "./Common";
...
class ClassBuilder{
    ...
    create(ctx){
        ...
        let creator = this.createCreator(
            ctx,
            module,
            this.getModuleDeclarationId(module),
    ...
    createBody(ctx, module, stack){
        ...
        if(!this.construct){
            this.construct = this.createDefaultConstructor(ctx, this.getModuleDeclarationId(module), module.inherit);
        }
    ...
    getHashId(len=8){
        ...
        return createUniqueHashId(`${file}:${name}`, len)
    }
    ...
    checkConstructor(ctx, construct, module){
        ...
        construct.kind = '';
        construct.key.value = this.getModuleDeclarationId(module);
