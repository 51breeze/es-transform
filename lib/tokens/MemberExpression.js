...
function MemberExpression(ctx,stack){
    ...
    if(stack.object.isIdentifier && Utils.isTypeModule(description) && description.id === stack.object.value()){
    ...
    if(objectType && Namespace.is(objectType) && (Utils.isClassType(description) || Utils.isInterface(description) && !description.isStructTable)){
        ctx.addDepend( description,stack.module );
